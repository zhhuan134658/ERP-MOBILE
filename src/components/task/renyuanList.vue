  ...
  <div id="addrenyuan">
    <div v-for="(item, index) in chaosongList" :key="index">
      <div class="item_renyuan">
        <van-icon v-if="allshow" name="cross" @click="deleteren(item)" />
        <div class="itemname">
      ...
      <div class="item_icon" v-if="allshow">
        <i class="el-icon-plus"></i>
      </div>
    </div>
    <div class="item_renyuan" v-if="allshow">
      <div class="itemname">
        <img
          @click="addren"
...
export default {
  ...
  created() {
    ...
    if (this.$route.query.type == "creat") {
      this.allshow = true;
    } else {
      this.allshow = false;
    }
