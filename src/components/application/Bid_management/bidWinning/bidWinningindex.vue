            ...
            >
                ...
                >
                    ...
                    <div class="btem">
                        ...
                        <div class="btem2">{{ item.register }}</div>
                    </div>
                    <div class="btem">
                    ...
                    <div class="btem">
                        <div class="btem1">建设单位:</div>
                        <div class="btem2">{{ item.construction_unit }}</div>
                    </div>
...
export default {
  ...
  methods: {
    ...
    getInfo() {
      this.$axios
        .post("/project/bidWinningRegisterList", {
    ...
    deleteitem(item) {
      ...
      Dialog.confirm({
        ...
        .then(() => {
          this.$axios
            .post("/project/bidWinningRegisterDel", {
              id: [item.id],
            })
            .then((res) => {
              if (res.data.code == 1) {
    ...
    creatin() {
      ...
      _this.$axios.post("/project/bidWinningRegister").then((res) => {
        if (res.data.code == 1) {
          _this.openurl =
