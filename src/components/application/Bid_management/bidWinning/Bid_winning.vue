      ...
      <!-- <div
            ...
            >
                ...
                >
                    ...
                    <div class="btem">
                        <div class="btem1">中标单位:</div>
                        <div class="btem2">{{ item.company }}</div>
                    </div>
                    <div class="btem">
                        <div class="btem1">金额:</div>
                        <div class="btem2">{{ item.money }}</div>
                    </div>
                    <div class="btem">
                        <div class="btem1">联系电话:</div>
                        <div class="btem2">{{ item.contacts_mobile }}</div>
                    </div>
...
export default {
  ...
  methods: {
    ...
    getInfo() {
      this.$axios
        .post("/project/zbWinningRegisterList", {
    ...
    deleteitem(item) {
      ...
      Dialog.confirm({
        ...
        .then(() => {
          this.$axios
            .post("/project/zbWinningRegisterDel", {
              id: [item.id],
            })
            .then((res) => {
              if (res.data.code == 1) {
    ...
    creatin() {
      ...
      _this.$axios.post("/project/zbWinningRegister").then((res) => {
        if (res.data.code == 1) {
          _this.openurl =
