      ...
      <!-- <div
            ...
            >
                ...
                >
                    ...
                    <div class="btem">
                        <div class="btem1">申请人:</div>
                        <div class="btem2">{{ item.applicant }}</div>
                    </div>
                    <div class="btem">
                        <div class="btem1">申请金额:</div>
                        <div class="btem2">{{ item.type }}</div>
                    </div>
                    <div class="btem">
                        <div class="btem1">申请事由:</div>
...
export default {
  ...
  data() {
    return {
      valname: "project_operation_cost",
      waringdata: false,
      // 筛选
      typename: "",
      shenpitype: "",
  ...
  methods: {
    ...
    getInfo() {
      this.$axios
        .post("/project/projectOperationCostList", {
    ...
    deleteitem(item) {
      ...
      Dialog.confirm({
        ...
        .then(() => {
          this.$axios
            .post("/project/projectOperationCostDel", {
              id: [item.id],
            })
            .then((res) => {
              if (res.data.code == 1) {
    ...
    creatin() {
      ...
      _this.$axios.post("/project/projectOperationCost").then((res) => {
        if (res.data.code == 1) {
          _this.openurl =
