      ...
      <!-- <div
            ...
            >
                ...
                >
                    ...
                    <div class="btem">
                        <div class="btem1">投标人:</div>
                        <div class="btem2">{{ item.bidder }}</div>
                    </div>
...
export default {
  ...
  methods: {
    ...
    getInfo() {
      this.$axios
        .post("/project/bidOpeningRegisterList", {
    ...
    deleteitem(item) {
      ...
      Dialog.confirm({
        ...
        .then(() => {
          this.$axios
            .post("/project/bidOpeningRegisterDel", {
              id: [item.id],
            })
            .then((res) => {
              if (res.data.code == 1) {
    ...
    creatin() {
      ...
      _this.$axios.post("/project/bidOpeningRegister").then((res) => {
        if (res.data.code == 1) {
          _this.openurl =
