...
export default {
  ...
  methods: {
    ...
    getInfo() {
      this.$axios
        .post("/project/outputValueRegisterList", {
    ...
    deleteitem(item) {
      ...
      Dialog.confirm({
        ...
        .then(() => {
          this.$axios
            .post("/project/outputValueRegisterDel", {
              id: [item.id],
            })
            .then((res) => {
              if (res.data.code == 1) {
    ...
    creatin() {
      ...
      _this.$axios.post("/project/outputValueRegister").then((res) => {
        if (res.data.code == 1) {
          _this.openurl =
