    ...
    <van-list v-model="loading" :finished="finished" @load="onLoad">
      <div class="renwucontent" v-for="(item, index) in FilesList" :key="index">
        <div style="padding: 0.5rem 1rem" @click="lookinfo(item)">
          ...
          <div class="btem">
            <div class="btem1">事故金额:</div>
            <div class="btem2">{{ item.accidenmoney }}</div>
          </div>
          <div class="btem">
            <div class="btem1">事故等级:</div>
            <div class="btem2">{{ item.accidentGrade }}</div>
          </div>
          <div class="btem">
            <div class="btem1">事故类型:</div>
            <div class="btem2">{{ item.accidenttype }}</div>
          </div>
        </div>
