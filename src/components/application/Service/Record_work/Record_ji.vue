  ...
  methods: {
    setTitle() {
      ...
      dd.ready(function () {
        dd.biz.navigation.setTitle({
          title: "记工编辑", //控制标题文本，空字符串表示显示默认文本
    ...
    getinfo() {
      this.$axios
        ...
        .then((res) => {
          this.personnelFrom.durationname = res.data.content.duration;
          this.personnelFrom.remarks = res.data.content.remarks;
          ...
          this.personnelFrom.enclosure = res.data.content.enclosure;

          this.personnelFrom.participants = [res.data.content.participants];
          this.personnelFrom.participants_id = [
            res.data.content.participants_id,
          ];
