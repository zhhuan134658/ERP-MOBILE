...
export default {
  ...
  methods: {
    ...
    getInfo() {
      this.$axios
        .post("/project/projectWageRegisterList", {
    ...
    deleteitem(item) {
      ...
      Dialog.confirm({
        ...
        .then(() => {
          this.$axios
            .post("/project/projectWageRegisterDel", {
              id: [item.id],
            })
            .then((res) => {
              if (res.data.code == 1) {
    ...
    creatin() {
      ...
      _this.$axios.post("/project/projectWageRegister").then((res) => {
        if (res.data.code == 1) {
          _this.openurl =
