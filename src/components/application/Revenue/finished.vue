...
export default {
  ...
  data() {
    return {
      valname: "income_completion_settlement",
      waringdata: false,
      // 筛选
      typename: "",
      shenpitype: "",
  ...
  methods: {
    ...
    getInfo() {
      this.$axios
        .post("/project/incomeCompletionSettlementList", {
    ...
    deleteitem(item) {
      ...
      Dialog.confirm({
        ...
        .then(() => {
          this.$axios
            .post("/project/incomeCompletionSettlementDel", {
              id: [item.id],
            })
            .then((res) => {
              if (res.data.code == 1) {
    ...
    creatin() {
      ...
      _this.$axios.post("/project/incomeCompletionSettlement").then((res) => {
        if (res.data.code == 1) {
          _this.openurl =
