...
export default {
  ...
  methods: {
    ...
    getInfo() {
      this.$axios
        .post("/project/technicalDisclosureList", {
    ...
    deleteitem(item) {
      ...
      Dialog.confirm({
        ...
        .then(() => {
          this.$axios
            .post("/project/technicalDisclosureDel", {
              id: [item.id],
            })
            .then((res) => {
              if (res.data.code == 1) {
    ...
    creatin() {
      ...
      _this.$axios.post("/project/technicalDisclosure").then((res) => {
        if (res.data.code == 1) {
          _this.openurl =
