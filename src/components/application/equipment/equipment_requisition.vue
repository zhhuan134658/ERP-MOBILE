...
export default {
  ...
  methods: {
    ...
    getInfo() {
      this.$axios
        .post("/project/equipmentRequisitionList", {
    ...
    deleteitem(item) {
      ...
      Dialog.confirm({
        ...
        .then(() => {
          this.$axios
            .post("/project/equipmentRequisitionDel", {
              id: [item.id],
            })
            .then((res) => {
              if (res.data.code == 1) {
    ...
    creatin() {
      ...
      _this.$axios.post("/project/equipmentRequisition").then((res) => {
        if (res.data.code == 1) {
          _this.openurl =
