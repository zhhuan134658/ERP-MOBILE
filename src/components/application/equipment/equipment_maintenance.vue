...
export default {
  ...
  methods: {
    ...
    getInfo() {
      this.$axios
        .post("/project/equipmentMaintenanceList", {
    ...
    deleteitem(item) {
      ...
      Dialog.confirm({
        ...
        .then(() => {
          this.$axios
            .post("/project/equipmentMaintenanceDel", {
              id: [item.id],
            })
            .then((res) => {
              if (res.data.code == 1) {
    ...
    creatin() {
      ...
      _this.$axios.post("/project/equipmentMaintenance").then((res) => {
        if (res.data.code == 1) {
          _this.openurl =
