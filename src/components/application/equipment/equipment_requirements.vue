...
export default {
  ...
  methods: {
    ...
    getInfo() {
      this.$axios
        .post("/project/equipmentDemandPlanList", {
    ...
    deleteitem(item) {
      ...
      Dialog.confirm({
        ...
        .then(() => {
          this.$axios
            .post("/project/equipmentDemandPlanDel", {
              id: [item.id],
            })
            .then((res) => {
              if (res.data.code == 1) {
    ...
    creatin() {
      ...
      _this.$axios.post("/project/equipmentDemandPlan").then((res) => {
        if (res.data.code == 1) {
          _this.openurl =
