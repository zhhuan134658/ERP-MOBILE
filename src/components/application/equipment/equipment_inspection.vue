...
export default {
  ...
  methods: {
    ...
    getInfo() {
      this.$axios
        .post("/project/equipmentInspectionList", {
    ...
    deleteitem(item) {
      ...
      Dialog.confirm({
        ...
        .then(() => {
          this.$axios
            .post("/project/equipmentInspectionDel", {
              id: [item.id],
            })
            .then((res) => {
              if (res.data.code == 1) {
    ...
    creatin() {
      ...
      _this.$axios.post("/project/equipmentInspection").then((res) => {
        if (res.data.code == 1) {
          _this.openurl =
