...
export default {
  ...
  data() {
    return {
      valname: "material_acceptance_register",
      waringdata: false,
      // 筛选
      typename: "",
      shenpitype: "",
  ...
  methods: {
    ...
    getInfo() {
      this.$axios
        .post("/project/materialAcceptanceRegisterList", {
    ...
    deleteitem(item) {
      ...
      Dialog.confirm({
        ...
        .then(() => {
          this.$axios
            .post("/project/materialAcceptanceRegisterDel", {
              id: [item.id],
            })
            .then((res) => {
              if (res.data.code == 1) {
    ...
    creatin() {
      ...
      _this.$axios.post("/project/materialAcceptanceRegister").then((res) => {
        if (res.data.code == 1) {
          _this.openurl =
