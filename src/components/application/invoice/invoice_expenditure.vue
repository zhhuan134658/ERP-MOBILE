...
export default {
  ...
  methods: {
    ...
    getInfo() {
      this.$axios
        .post("/project/expenditureFundPlanList", {
    ...
    deleteitem(item) {
      ...
      Dialog.confirm({
        ...
        .then(() => {
          this.$axios
            .post("/project/expenditureFundPlanDel", {
              id: [item.id],
            })
            .then((res) => {
              if (res.data.code == 1) {
    ...
    creatin() {
      ...
      _this.$axios.post("/project/expenditureFundPlan").then((res) => {
        if (res.data.code == 1) {
          _this.openurl =
