...
export default {
    ...
    methods: {
        ...
        getInfo() {
            this.$axios
                .post('/projecttwo/invoiceApplicationList', {
        ...
        deleteitem(item) {
            ...
            Dialog.confirm({
                ...
                .then(() => {
                    this.$axios
                        .post('/projecttwo/invoiceApplicationDel', {
                            id: [item.id]
                        })
                        .then((res) => {
                            if (res.data.code == 1) {
        ...
        creatin() {
            ...
            _this.$axios.post('/projecttwo/invoiceApplication').then((res) => {
                if (res.data.code == 1) {
                    _this.openurl =
