...
export default {
  ...
  methods: {
    ...
    getInfo() {
      this.$axios
        .post("/project/qualityRectificationList", {
    ...
    deleteitem(item) {
      ...
      Dialog.confirm({
        ...
        .then(() => {
          this.$axios
            .post("/project/qualityRectificationDel", {
              id: [item.id],
            })
            .then((res) => {
              if (res.data.code == 1) {
    ...
    creatin() {
      ...
      _this.$axios.post("/project/qualityRectification").then((res) => {
        if (res.data.code == 1) {
          _this.openurl =
