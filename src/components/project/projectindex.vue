<template>
  <!-- 项目看板 -->
  <div id="projectindexnew" v-if="isQlm">
    <!--项目搜索  -->
    <van-sticky>
      <div class="inputdiv">
        <van-search
      ...
      <div class="pr_concent">
        ...
        >
          ...
          <div class="title">
            产值金额:<span>{{ numbledata.zong_money }}</span>
          </div>
        </div>
        <div
          class="item"
        ...
        >
          ...
          <div class="title">
            产值金额:<span>{{ numbledata.zj_money }}</span>
          </div>
        </div>
        <div
          class="item"
        ...
        >
          ...
          <div class="title">
            产值金额: <span>{{ numbledata.xz_money }}</span>
          </div>
        </div>
        <div
          class="item"
        ...
        >
          ...
          <div class="title">
            产值金额:<span>{{ numbledata.jg_money }}</span>
          </div>
        </div>
      </div>
    </van-sticky>
    ...
    <div class="pr_list">
      ...
      >
        ...
        <div class="item_jindu">
          ...
          <van-progress
            :percentage="Math.round(item.jindu)"
            stroke-width="8"
            :show-pivot="false"
            color="#FF4848"
          />
...
export default {
  ...
  created() {
    ...
    if (
      ...
      this.$store.state.userData.cid ==
        "dinga090000f57c90b3eee0f45d8e4f7c288" ||
      this.$store.state.userData.cid == "dingb6f8d3afc6d3c2d024f2f5cc6abecb85"
    ) {
      console.log("4348");
      this.isQlm = true;
      this.onLoad(1);
