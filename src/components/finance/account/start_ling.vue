...
export default {
  ...
  data() {
    return {
      valname: "sporadic_service_payment",
      waringdata: false,
      // 筛选
      typename: "",
      shenpitype: "",
  ...
  methods: {
    ...
    creatin() {
      ...
      _this.$axios.post("/finance/sporadic").then((res) => {
        if (res.data.code == 1) {
          _this.openurl =
