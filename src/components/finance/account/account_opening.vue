...
export default {
  ...
  methods: {
    ...
    getInfo() {
      this.$axios
        .post("/finance/accountqclist", {
          current_page: this.current_page,
          num: "10",

          // starttime: this.starttime,
          // stoptime: this.stoptime,
          lctatus: this.shenpival,
          addtouser: "",
          accountname: this.Searchname,
    ...
    creatin() {
      ...
      _this.$axios.post("/finance/accountopening").then((res) => {
        if (res.data.code == 1) {
          _this.openurl =
