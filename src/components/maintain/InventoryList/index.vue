  ...
  <div id="spcreat">
    ...
    >
      ...
      <van-field
        ...
        readonly
        input-align="right"
        v-model="addUserForm.bxusername"
        name="报修人"
        label="报修人"
        placeholder="请填写报修人"
        :rules="[{ required: false }]"
      ...
      <van-field
        ...
        readonly
        input-align="right"
        v-model="addUserForm.fqusername"
        name="发起人"
        label="发起人"
        placeholder="请填写发起人"
        :rules="[{ required: false }]"
      ...
      <van-field
        ...
        input-align="right"
        v-model="addUserForm.sxaddressname"
        name="送修地点"
        readonly
        label="送修地点"
        placeholder="请填写送修地点"
...
export default {
  ...
  methods: {
        ...
        dd.biz.contact.complexPicker({
          ...
          onSuccess: function (result) {
            if (value == "bao") {
              ...
              that.addUserForm.bxuserid = result.users[0].empId;
            } else {
    ...
    onConfirm1(value) {
      console.log(value);
      if (this.selectype == 1) {
        this.addUserForm.wxstatus = value.name;
    ...
    onSubmit() {
      ...
      this.$axios
        .post("/erp_check/weixiuguanlicreatadd", this.addUserForm)
        .then((res) => {
          if (res.data.code == 1) {
            Toast(res.data.msg);
            this.$router.go(-1);
